...
class TestProjectBasics:
    ...
    def test_retrieve_content_around_line(self, project: Project) -> None:
        ...
        line_31 = project.filesystem.retrieve_content_around_line(file_path, 31)
        ...
        with_context_around_user = project.filesystem.retrieve_content_around_line(file_path, 31, 2, 2)
        ...
        with_context_above = project.filesystem.retrieve_content_around_line(file_path, 31, 3, 0)
        ...
        with_context_below = project.filesystem.retrieve_content_around_line(file_path, 31, 0, 3)
        ...
        first_line_with_context_around = project.filesystem.retrieve_content_around_line(file_path, 0, 2, 1)
        ...
        second_line_with_context_above = project.filesystem.retrieve_content_around_line(file_path, 1, 3, 1)
        ...
        all_content = project.filesystem.read_file(file_path)
        total_lines = len(all_content.split("\n"))

        last_line_with_context_around = project.filesystem.retrieve_content_around_line(file_path, total_lines - 1, 1, 3)
    ...
    def test_search_files_for_pattern(self, project: Project) -> None:
        ...
        matches = project.filesystem.search_source_files_for_pattern(class_pattern)
        ...
        matches = project.filesystem.search_source_files_for_pattern(user_class_pattern, paths_include_glob="**/models.py")
        ...
        matches = project.filesystem.search_source_files_for_pattern(method_pattern, paths_exclude_glob="**/models.py")
        assert len(matches) > 0
        ...
        matches = project.filesystem.search_source_files_for_pattern(
        ...
        matches = project.filesystem.search_source_files_for_pattern(init_pattern)
        ...
        matches = project.filesystem.search_source_files_for_pattern(no_match_pattern)
        assert len(matches) == 0
